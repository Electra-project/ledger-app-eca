...
APPNAME ="NIX"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),electra)
# Electra
DEFINES   += COIN_P2PKH_VERSION=33 COIN_P2SH_VERSION=40 COIN_FAMILY=1 COIN_COINID=\"Electra\" COIN_COINID_HEADER=\"ELECTRA\" COIN_COLOR_HDR=0x1685e8 COIN_COLOR_DB=0xffffff COIN_COINID_NAME=\"Electra\" COIN_COINID_SHORT=\"ECA\" COIN_KIND=COIN_KIND_ELECTRA
APPNAME ="Electra"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
